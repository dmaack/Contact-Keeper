...
const { check, validationResult } = require('express-validator/check'); // (19) allows us to set checks on certain inputs
const bcrypt = require('bcryptjs'); // their methods return a promise
const jwt = require('jsonwebtoken');
const config = require('config');

const User = require('../models/User') // (17) -->add middleware to server
